...
subprocess.Popen(["ampy", "--port", "/dev/ttyACM0", "run", "six1.py"])

# Nastavení připojení SSH
ssh_port = 22
ssh_username = "pi"
ssh_password = "Vmdkm742"
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/hpk.py"

# Seznam IP adres zařízení
device_hosts = ["192.168.0.101", "192.168.0.105"]
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/dpv.py"

# Seznam IP adres zařízení
device_hosts = ["192.168.0.103", "192.168.0.107"]
# Použijeme ThreadPoolExecutor pro spuštění funkcí na různých zařízeních ve vláknech
with ThreadPoolExecutor() as executor:
    # Pro každé zařízení spustíme funkci run_on_device s odpovídajícím hostem
    futures = [executor.submit(run_on_device, host, remote_command) for host in device_hosts]
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/pizero/ff.py"
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/pizero/frc.py"
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/pizero/flc.py"
