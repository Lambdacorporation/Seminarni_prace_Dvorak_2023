...
subprocess.Popen(["ampy", "--port", "/dev/ttyACM0", "run", "nic.py"])
...
device_hosts = ["192.168.0.101", "192.168.0.107"]
...
# Seznam IP adres zařízení
device_hosts = ["192.168.0.103", "192.168.0.105"]
# Použijeme ThreadPoolExecutor pro spuštění funkcí na různých zařízeních ve vláknech
with ThreadPoolExecutor() as executor:
    # Pro každé zařízení spustíme funkci run_on_device s odpovídajícím hostem
    futures = [executor.submit(run_on_device, host, remote_command) for host in device_hosts]
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/pizero/fr.py"
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/pizero/rr.py"
...
remote_command = "python3 /home/pi/OLED_Module_Code/RaspberryPi/python/example/pizero/fl.py"
