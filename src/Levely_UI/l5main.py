...
class L1(customtkinter.CTkFrame):
    def __init__(self, master, values):
        ...
        #/home/pi/krizovatky/krizovatka5.jpg
        my_image = customtkinter.CTkImage(dark_image=Image.open("/home/pi/krizovatky/krizovatka5.jpg"), size=(400, 400))
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.radiobutton_frame = MyRadiobuttonFrame(self, "Options", values=["První pojede růžové auto, po něm modré auto a nakonec zelené auto", "První pojede zelené auto, druhé růžové auto a naposled pojede modré auto", "První pojede modré auto, po něm zelené, a nakonec růžové"])
    ...
    def button_callback(self):
        ...
        for radiobutton in self.radiobutton_frame.radiobuttons:
            if radiobutton.cget("value") == "První pojede zeĺené auto, druhé růžové auto a naposled pojede modré auto":
        ...
        elif selected_option == "První pojede modré auto, po něm zelené, a nakonec růžové":
            self.button.configure(text=button_new_text, command=self.o3_l1)
    def o1_l1(self):
        try:
            subprocess.run(["python", "5s1.py"])
            time.sleep(5)
            subprocess.run(["python", "5s1b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o2_l1(self):
        try:
            subprocess.run(["python", "5c.py"])
            time.sleep(5)
            subprocess.run(["python", "5cb.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o3_l1(self):
        try:
            subprocess.run(["python", "5s2.py"])
            time.sleep(5)
            subprocess.run(["python", "5s2b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def menu_port(self):
