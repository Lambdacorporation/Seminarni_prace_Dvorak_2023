...
class L1(customtkinter.CTkFrame):
    def __init__(self, master, values):
        ...
        #/home/pi/krizovatky/krizovatka4.jpg
        my_image = customtkinter.CTkImage(dark_image=Image.open("/home/pi/krizovatky/krizovatka4.jpg"), size=(400, 400))
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title = Title(self, "Křižovatka 4", values=["option 1", "option 2", "option 3"])
        ...
        self.radiobutton_frame = MyRadiobuttonFrame(self, "Options", values=["První pojede růžové auto, po něm modré auto a nakonec zelené auto", "První pojede zelené auto, druhé modré auto a naposled pojede růžové auto", "První pojede modré auto, po něm zelené, a nakonec růžové"])
    ...
    def button_callback(self):
        ...
        for radiobutton in self.radiobutton_frame.radiobuttons:
            if radiobutton.cget("value") == "První pojede modré auto, po něm zelené, a nakonec růžové":
        ...
        elif selected_option == "První pojede zelené auto, druhé modré auto a naposled pojede růžové auto":
    ...
    def o1_l1(self):
        try:
            subprocess.run(["python", "4s1.py"])
            time.sleep(5)
            subprocess.run(["python", "4s1b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o2_l1(self):
        try:
            subprocess.run(["python", "4s2.py"])
            time.sleep(5)
            subprocess.run(["python", "4s2b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o3_l1(self):
        try:
            subprocess.run(["python", "4c.py"])
            time.sleep(5)
            subprocess.run(["python", "4cb.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def menu_port(self):
