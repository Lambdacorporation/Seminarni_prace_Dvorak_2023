...
class L1(customtkinter.CTkFrame):
    def __init__(self, master, values):
        ...
        #C:/Users/domca/Documents/Dominik/Škola/Stáž/krizovatky/krizovatka3_2.jpg
        my_image = customtkinter.CTkImage(dark_image=Image.open("/home/pi/krizovatky/krizovatka3_2.jpg"), size=(400, 400))
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title = Title(self, "Křižovatka 3", values=["option 1", "option 2", "option 3"])
        ...
        self.radiobutton_frame = MyRadiobuttonFrame(self, "Options", values=["První pojede růžové auto, a po něm modré současně se zeleným", "První pojede zelené auto současně s modrým, naposled pojede růžové auto", "První pojede zelené auto, po něm růžové, a nakonec modré"])
    ...
    def button_callback(self):
        ...
        elif selected_option == "První pojede zelené auto, po něm růžové, a nakonec modré":
            self.button.configure(text=button_new_text, command=self.o3_l1)
    def o1_l1(self):
        try:
            subprocess.run(["python", "3s1.py"])
            time.sleep(5)
            subprocess.run(["python", "3s1b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o2_l1(self):
        try:
            subprocess.run(["python", "3c.py"])
            time.sleep(5)
            subprocess.run(["python", "3cb.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o3_l1(self):
        try:
            subprocess.run(["python", "3s2.py"])
            time.sleep(5)
            subprocess.run(["python", "3s2b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def menu_port(self):
