...
class L1(customtkinter.CTkFrame):
    def __init__(self, master, values):
        ...
        #C:/Users/domca/Documents/Dominik/Škola/Stáž/krizovatky/krizovatka2_2.jpg
        my_image = customtkinter.CTkImage(dark_image=Image.open("C:/Users/domca/Documents/Dominik/Škola/Stáž/krizovatky/krizovatka2_2.jpg"), size=(400, 400)) #/home/pi/krizovatky/krizovatka2_2.jpg
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title = Title(self, "Křižovatka 2", values=["option 1", "option 2", "option 3"])
        ...
        self.radiobutton_frame = MyRadiobuttonFrame(self, "Options", values=["První pojede růžové auto, a po něm modré současně se zeleným", "První pojede zelené auto současně s modrým, naposled pojede růžové auto", "První pojede růžové auto, po něm zelené, a nakonec modré"])
    ...
    def button_callback(self):
        ...
        for radiobutton in self.radiobutton_frame.radiobuttons:
            if radiobutton.cget("value") == "První pojede zelené auto současně s modrým, naposled pojede růžové auto":
        ...
        if selected_option == "První pojede růžové auto, a po něm modré současně se zeleným":
            self.button.configure(text=button_new_text, command=self.o1_l1)
        elif selected_option == "První pojede zelené auto současně s modrým, naposled pojede růžové auto":
            self.button.configure(text=button_new_text, command=self.o2_l1)
        elif selected_option == "První pojede růžové auto, po něm zelené, a nakonec modré":
            self.button.configure(text=button_new_text, command=self.o3_l1)
    def o1_l1(self):
        try:
            subprocess.run(["python", "2s1.py"])
            time.sleep(5)
            subprocess.run(["python", "2s1b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o2_l1(self):
        try:
            subprocess.run(["python", "2c.py"])
            time.sleep(5)
            subprocess.run(["python", "2cb.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def o3_l1(self):
        try:
            subprocess.run(["python", "2s2.py"])
            time.sleep(5)
            subprocess.run(["python", "2s2b.py"])
        except Exception as e:
            print(f"Chyba při spouštění skriptu: {e}")
    def menu_port(self):
